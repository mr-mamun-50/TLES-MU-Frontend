      ...
      <Box className='card my-2 col-lg-8'>
        ...
        {loading ? <Box className="text-center"><span className='spinner-border my-5'></span></Box> :
          <Box className="card-body">
            ...
            {/* view all questions */}
            {questionSets.length === 0 ? <Box className="text-center my-5">No questions added yet</Box> :
              questionSets.map((questionSet, questionSetIndex) => (
                <Box className='card card-body pt-3 mt-3 shadow-sm border border-light-grey' key={questionSetIndex}>

                  {/* type and actions */}
                  <Box className="d-flex justify-content-between align-items-end mb-3">
                    {/* sl and type */}
                  ...
                  {questionSet.questions.map((question, questionIndex) => (
                    <Box className='d-flex justify-content-between border-bottom border-light-grey mx-3' key={questionIndex}>
